...
class UltrasoundRendering(torch.nn.Module):
    ...
    def rendering(self, H, W, z_vals=None, refl_map=None, boundary_map=None):
        ...
        if self.params.cuss_mode: attenuation_total = attenuation_total * CUSS_COEFF #*10
        ...
        # if CUSS_MODE: refl_map = refl_map / 10  
        # if CUSS_MODE: boundary_map = boundary_map / 2
