...
class CUSSEnd2EndOptions():
    ...
    def initialize(self, parser):
        ...
        # parser.add_argument('--load_size', type=int, default=286, help='scale images to this size')     #default
        ...
        # parser.add_argument('--lr', type=float, default=0.002, help='initial learning rate for adam') #default
        # parser.add_argument('--lr', type=float, default=0.0002, help='initial learning rate for adam') 
        # parser.add_argument('--lr', type=float, default=0.00001, help='initial learning rate for adam')     #orig lr
        
        parser.add_argument('--lr', type=float, default=0.000005, help='initial learning rate for adam')  #cuss
