...
def build_configargparser(parser):
    ...
    parser.add_argument("--cuss_dataset", type=str, required=False)
    ...
    parser.add_argument("--cuss_mode",  action="store_true")
    ...
    parser.add_argument("--cuss_data_dir", default=None, type=str)
    parser.add_argument("--polyaxon_cuss_data_dir", default=None, type=str)
